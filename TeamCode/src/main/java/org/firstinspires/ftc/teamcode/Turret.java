...
public class Turret {
    ...
    PIDFController yawPIDF = new PIDFController(4.2, 0, 0.3);
    ...
    public static class Basket {
        ...
        public double maxShotVelocity() {
            return shotVelocity(shotFar) * (1 + (shotFar.x - 2) * 0.016);
        }

        public double minShotVelocity() {
            return shotVelocity(shotNear) * (1 + (shotFar.x - 2) * 0.016) * 0.85;
        }
    ...
    public static class Shooter {
        ...
        PIDFController pidf = new PIDFController(0.15, 0, 0, 1 / MAX_FLYWHEEL_VELOCITY);
